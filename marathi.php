      ...
      <div class="trend_2i row">
		...
		<div class="col-md-3 col-6">
		  ...
		  <div class="trend_2ilast bg_grey p-3 clearfix">
			...
			<p class="mb-2">Shraddha wants her fiancé to fulfill an unusual vow before marriage. Her parents, Bhakti and Vacky, embark on a pilgrimage to seek divine blessings to make it happen.</p>
			<span class="col_red">
		 <i class="fa fa-star"></i>
		 <i class="fa fa-star"></i>
		 <i class="fa fa-star"></i>
